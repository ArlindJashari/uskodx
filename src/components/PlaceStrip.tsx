const ITEMS = [
  ...
  { img: '/images/F3.webp', label: 'Platform floors', h: 195, top: 8 },
  { img: '/images/F4.webp', label: 'Network fabric', h: 218, top: 0 },
  { img: '/images/F5.webp', label: 'Material detail', h: 232, top: 44 },
  { img: '/images/F6.webp', label: 'Delivery rhythm', h: 205, top: 12 },
  { img: '/images/F7.webp', label: 'Structural light', h: 228, top: 36 },
]
